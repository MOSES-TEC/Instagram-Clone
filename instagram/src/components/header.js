            ...
            {user ? (
              ...
              <>
                <Link to={ROUTES.LOGIN}>
                  <button className="bg-blue-medium font-bold test-sm rounded text-white w-20 h-8" type="button">Log In</button>
                </Link>
                <Link to={ROUTES.SIGN_UP}>
                  <button className="font-bold test-sm rounded text-blue-medium w-20 h-8" type="button">Sign Up</button>
                </Link>
              </>
            )}
          </div>
